...
TimedCondition::TimedCondition(BgCore &game):TimedCondition(game, e_round_changed) {}

TimedCondition::TimedCondition(BgCore &game, common_events_t check_on) : _game(game), _check_on(check_on) {
